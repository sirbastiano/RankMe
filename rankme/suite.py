...
from rankme.network import Flops, InferenceTime, ModelSizeMB, ParamCount, PrecisionBits
...
class ModelBenchmark:
    ...
    def benchmark_network(
        ...
        **kwargs: Any,
        ...
        # Parameter count
        total_params = self.network_metrics["param_count"](
            model, include_non_trainable=True
        )
        trainable_params = self.network_metrics["param_count"](
            model, include_non_trainable=False
        )
    ...
    def benchmark_features(
        self, embeddings: torch.Tensor, **kwargs: Any
    ) -> Dict[str, Any]:
    ...
    def benchmark_regression(
        self, y_pred: torch.Tensor, y_true: torch.Tensor, **kwargs: Any
    ) -> Dict[str, Any]:
    ...
    def full_benchmark(
        ...
        **kwargs: Any,
        ...
        if (
            y_pred_class is not None
            and y_true_class is not None
    ...
    def print_results(self, results: Dict[str, Any]) -> None:
        ...
        if "network" in results:
            ...
            if (
                "gpu_inference_time_ms" in net
                and net["gpu_inference_time_ms"] is not None
            ):
